					...
					<a href="login.php">Homepage</a>
						<li class="dropdown-submenu">
       			 		...
       			 		<ul class="dropdown-menu">
          					 <li><a tabindex="-1" href="mainpage.php">View Faculty Schedule</a></li>
							   <li><a tabindex="-1" href="newattendance.php">View Faculty Attendance</a></li>
						</li>
						</ul>
				   		<li class="dropdown-submenu">
        					<a class="test" tabindex="-1">Faculty Menu <span class="caret"></span></a>
       			 		<ul class="dropdown-menu">
							<li><a tabindex="-1" href="timein.php">Faculty Attendance</a></li>
						</li>
						</ul>
			</div>
		</div>
